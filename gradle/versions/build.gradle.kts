dependencies.constraints {
    ...
    api("io.netty:netty-transport:4.1.109.Final") {
        because("io.netty.transport")
    }
    api("io.netty:netty-transport-classes-epoll:4.1.109.Final") {
    ...
    api("org.apache.commons:commons-text:1.11.0") {
        because("org.apache.commons.text")
    }
